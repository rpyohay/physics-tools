...
typedef TriggerCandProducer< reco::GenParticle > trgMatchedGenParticleProducer;
DEFINE_FWK_MODULE( trgMatchedGenParticleProducer );

#include "DataFormats/TauReco/interface/PFTau.h"
typedef TriggerCandProducer< reco::PFTau > trgMatchedTauProducer;
DEFINE_FWK_MODULE( trgMatchedTauProducer );
