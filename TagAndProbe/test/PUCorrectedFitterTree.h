#ifndef PUCorrectedFitterTree_h
#define PUCorrectedFitterTree_h

#include <TROOT.h>
#include <TChain.h>
#include <TFile.h>

class PUCorrectedFitterTree {
public :
   ...
   PUCorrectedFitterTree(const std::string&, const std::string&, TTree *tree=0);
   virtual ~PUCorrectedFitterTree();
...
#ifdef PUCorrectedFitterTree_cxx
PUCorrectedFitterTree::PUCorrectedFitterTree(const std::string& file, const std::string& dir, 
					     TTree *tree)
{
...
PUCorrectedFitterTree::~PUCorrectedFitterTree()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t PUCorrectedFitterTree::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t PUCorrectedFitterTree::LoadTree(Long64_t entry)
{
...
void PUCorrectedFitterTree::Init(TTree *tree)
{
...
Bool_t PUCorrectedFitterTree::Notify()
{
...
void PUCorrectedFitterTree::Show(Long64_t entry)
{
...
Int_t PUCorrectedFitterTree::Cut(/*Long64_t entry*/)
{
...
#endif // #ifdef PUCorrectedFitterTree_cxx
