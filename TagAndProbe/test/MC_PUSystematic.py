...
process.TagProbeFitTreeAnalyzer = cms.EDAnalyzer(
    ...
    "/data2/yohay/eff_MC/analysis_defaultPU_ZJetToEE_Pt-15to20_TuneZ2_7TeV_pythia6-Summer11-PU_S3_START42_V11-v2/tagProbeTree_MC_photonToID_finalv2.root",
    ...
    "/data2/yohay/eff_MC/analysis_defaultPU_G_Pt-15to30_TuneZ2_7TeV_pythia6-Summer11-PU_S3_START42_V11-v2/tagProbeTree_MC_photonToID_finalv2.root",
    ...
    InputDirectoryName = cms.string("PhotonToIDEB"),
    InputTreeName = cms.string("fitter_tree"),
    OutputFileName = cms.string(
    "/data2/yohay/eff_MC/PU_systematic/efficiency_PhotonToIDEB_1-4PVs_1PlusJet.root"
    ),
    ...
    Categories = cms.PSet(mcTrue = cms.vstring("MC true", "dummy[true=1,false=0]"),
                          probe_passing_sigmaIetaIeta_EB = cms.vstring("isMuon",
                                                                       "dummy[pass=1,fail=0]")
                          ),
...
##     "RooCMSShape::backgroundFail(mass, aFail[79.8, 50.0, 90.0], bFail[0.081, 0.05, 0.5], gFail[0.02, 0.002, 0.2], peakFail[91.2, 80.0, 100.0])",
    ...
    unbinned = cms.PSet(EfficiencyCategoryAndState = cms.vstring("probe_passing_sigmaIetaIeta_EB",
                                                                 "pass"),
                        UnbinnedVariables = cms.vstring("mass", "weight"),
                        BinnedVariables = cms.PSet(
    probe_nJets05 = cms.vdouble(0.5, 15.5),
    event_nPV = cms.vdouble(0.5, 4.5),
