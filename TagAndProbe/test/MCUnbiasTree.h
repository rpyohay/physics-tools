#ifndef MCUnbiasTree_h
#define MCUnbiasTree_h
...
public :
   ...
   MCUnbiasTree(const std::string&, const std::string&, TTree *tree=0);
   virtual ~MCUnbiasTree();
...
#ifdef MCUnbiasTree_cxx
MCUnbiasTree::MCUnbiasTree(const std::string& file, const std::string& dir, TTree *tree)
{
...
MCUnbiasTree::~MCUnbiasTree()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t MCUnbiasTree::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t MCUnbiasTree::LoadTree(Long64_t entry)
{
...
void MCUnbiasTree::Init(TTree *tree)
{
...
void MCUnbiasTree::Show(Long64_t entry)
{
...
Int_t MCUnbiasTree::Cut(/*Long64_t entry*/)
{
