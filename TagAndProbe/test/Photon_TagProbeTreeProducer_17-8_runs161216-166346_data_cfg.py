...
process.selectedIsoVLR9IdPhotonsPassingHLT36CaloIdL22CaloIdLLeadingEB.hltTags = cms.VInputTag(
    cms.InputTag("HLT_Photon36_CaloIdL_Photon22_CaloIdL_v1", "", InputTagProcess),
    cms.InputTag("HLT_Photon36_CaloIdL_Photon22_CaloIdL_v2", "", InputTagProcess),
    cms.InputTag("HLT_Photon36_CaloIdL_Photon22_CaloIdL_v3", "", InputTagProcess),
    cms.InputTag("HLT_Photon36_CaloIdL_Photon22_CaloIdL_v4", "", InputTagProcess),
    cms.InputTag("HLT_Photon36_CaloIdL_Photon22_CaloIdL_v5", "", InputTagProcess)
    )
process.selectedIsoVLR9IdPhotonsPassingHLT36CaloIdL22CaloIdLLeadingEB.triggerEventTag = cms.untracked.InputTag("hltTriggerSummaryAOD", "", InputTagProcess)
process.selectedIsoVLR9IdPhotonsPassingHLT36CaloIdL22CaloIdLLeadingEB.triggerResultsTag = cms.untracked.InputTag("TriggerResults", "", InputTagProcess)
process.selectedIsoVLR9IdPhotonsPassingHLT36CaloIdL22CaloIdLLeadingEB.HLTSubFilters = cms.untracked.VInputTag("hltEG36CaloIdLClusterShapeFilter", "hltEG36CaloIdLClusterShapeLastFilter")

#photons passing IsoVL that fire the leading leg of 36 CaloIdL / 22 CaloIdL
process.selectedIsoVLPhotonsPassingHLT36CaloIdL22CaloIdLLeadingEB.hltTags = cms.VInputTag(
    cms.InputTag("HLT_Photon36_CaloIdL_Photon22_CaloIdL_v1", "", InputTagProcess),
    cms.InputTag("HLT_Photon36_CaloIdL_Photon22_CaloIdL_v2", "", InputTagProcess),
    cms.InputTag("HLT_Photon36_CaloIdL_Photon22_CaloIdL_v3", "", InputTagProcess),
    cms.InputTag("HLT_Photon36_CaloIdL_Photon22_CaloIdL_v4", "", InputTagProcess),
...
process.selectedIsoVLPhotonsPassingHLT36CaloIdL22CaloIdLLeadingEB.triggerEventTag = cms.untracked.InputTag("hltTriggerSummaryAOD", "", InputTagProcess)
process.selectedIsoVLPhotonsPassingHLT36CaloIdL22CaloIdLLeadingEB.triggerResultsTag = cms.untracked.InputTag("TriggerResults", "", InputTagProcess)
process.selectedIsoVLPhotonsPassingHLT36CaloIdL22CaloIdLLeadingEB.HLTSubFilters = cms.untracked.VInputTag("hltEG36CaloIdLClusterShapeFilter", "hltEG36CaloIdLClusterShapeLastFilter")

##################### 36 CaloIdL / 22 CaloIdL trailing #####################

#photons passing IsoVL && R9Id that fire the trailing leg of 36 CaloIdL / 22 CaloIdL
process.selectedIsoVLR9IdPhotonsPassingHLT36CaloIdL22CaloIdLTrailingEB.hltTags = cms.VInputTag(
    cms.InputTag("HLT_Photon36_CaloIdL_Photon22_CaloIdL_v1", "", InputTagProcess),
    cms.InputTag("HLT_Photon36_CaloIdL_Photon22_CaloIdL_v2", "", InputTagProcess),
    cms.InputTag("HLT_Photon36_CaloIdL_Photon22_CaloIdL_v3", "", InputTagProcess),
    cms.InputTag("HLT_Photon36_CaloIdL_Photon22_CaloIdL_v4", "", InputTagProcess),
...
process.selectedIsoVLR9IdPhotonsPassingHLT36CaloIdL22CaloIdLTrailingEB.triggerEventTag = cms.untracked.InputTag("hltTriggerSummaryAOD", "", InputTagProcess)
process.selectedIsoVLR9IdPhotonsPassingHLT36CaloIdL22CaloIdLTrailingEB.triggerResultsTag = cms.untracked.InputTag("TriggerResults", "", InputTagProcess)
process.selectedIsoVLR9IdPhotonsPassingHLT36CaloIdL22CaloIdLTrailingEB.HLTSubFilters = cms.untracked.VInputTag(
...
process.selectedIsoVLPhotonsPassingHLT36CaloIdL22CaloIdLTrailingEB.hltTags = cms.VInputTag(
    cms.InputTag("HLT_Photon36_CaloIdL_Photon22_CaloIdL_v1", "", InputTagProcess),
    cms.InputTag("HLT_Photon36_CaloIdL_Photon22_CaloIdL_v2", "", InputTagProcess),
    cms.InputTag("HLT_Photon36_CaloIdL_Photon22_CaloIdL_v3", "", InputTagProcess),
    cms.InputTag("HLT_Photon36_CaloIdL_Photon22_CaloIdL_v4", "", InputTagProcess),
...
process.selectedIsoVLPhotonsPassingHLT36CaloIdL22CaloIdLTrailingEB.triggerEventTag = cms.untracked.InputTag("hltTriggerSummaryAOD", "", InputTagProcess)
process.selectedIsoVLPhotonsPassingHLT36CaloIdL22CaloIdLTrailingEB.triggerResultsTag = cms.untracked.InputTag("TriggerResults", "", InputTagProcess)
process.selectedIsoVLPhotonsPassingHLT36CaloIdL22CaloIdLTrailingEB.HLTSubFilters = cms.untracked.VInputTag(
    "hltPhoton36CaloIdLPhoton22CaloIdLEgammaClusterShapeDoubleFilter",
    "hltDoubleIsoEG22ClusterShapeDoubleLastFilterUnseeded"
    )
...
process.tagAndProbe = cms.Path(process.probe_sequence + process.iso_sequence + 
                               ...
                               process.trigger_sequence_May10ReReco2 + process.tag_sequence +
                               process.tag_and_probe_sequence +
                               process.jet_variable_sequence_2011 +
                               process.efficiency_sequence_May10ReReco2)
