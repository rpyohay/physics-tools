...
// Thu Aug 11 13:42:08 2011 by ROOT version 5.27/06b
// from TTree fitter_tree/fitter_tree
// found on file: /data2/yohay/analysis_CMSSWv425_golden_JSON_24052011_defaultPU_Photon-Run2011A-DoublePhoton-May10ReReco-v1/tagProbeTree_data_photonToID_final.root
//////////////////////////////////////////////////////////
...
#ifdef DataTree_cxx
DataTree::DataTree(TTree *tree)
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/data2/yohay/analysis_CMSSWv425_golden_JSON_24052011_defaultPU_Photon-Run2011A-DoublePhoton-May10ReReco-v1/tagProbeTree_data_photonToID_final.root");
      if (!f) {
         f = new TFile("/data2/yohay/analysis_CMSSWv425_golden_JSON_24052011_defaultPU_Photon-Run2011A-DoublePhoton-May10ReReco-v1/tagProbeTree_data_photonToID_final.root");
      }
