...
process.TagProbeFitTreeAnalyzer = cms.EDAnalyzer(
    ...
    "/data2/yohay/DIR_NAME/tagProbeTree_data_photonToID_final.root"
    ),
    ...
    "/data2/yohay/DIR_NAME/efficiency_data_INPUT_DIRECTORY_NAME_LABEL.root"
    ),
...
##     probe_nJets05 = cms.vdouble(-0.5, 0.5),
...
##     probe_nJets05 = cms.vdouble(0.5, 15.5),
    ...
    nJets05 = cms.PSet(EfficiencyCategoryAndState = cms.vstring("PASS", "pass"),
                       UnbinnedVariables = cms.vstring("mass"),
                       BinnedVariables = cms.PSet(
##     dRTagProbe = cms.vdouble(2.0, 10.0),
    probe_SC_eta = cms.vdouble(-1.4442, 1.4442),
...
##     probe_nJets05 = cms.vdouble(0.5, 15.5),
    ...
    R9 = cms.PSet(EfficiencyCategoryAndState = cms.vstring("PASS", "pass"),
                  UnbinnedVariables = cms.vstring("mass"),
                  BinnedVariables = cms.PSet(
    probe_SC_eta = cms.vdouble(-1.4442, 1.4442),
    ...
    dRTagProbe = cms.PSet(EfficiencyCategoryAndState = cms.vstring("PASS", "pass"),
                          UnbinnedVariables = cms.vstring("mass"),
                          BinnedVariables = cms.PSet(
    probe_SC_eta = cms.vdouble(-1.4442, 1.4442),
