#define PUCorrectedFitterTree_cxx
...
void PUCorrectedFitterTree::Loop(TTree* tree, Float_t& totalWeight, Float_t& SCEta, 
				 Int_t& probePassingRhoSigmaIetaIetaEB, 
				 Int_t& probePassingNPVSigmaIetaIetaEB, Float_t& dRTagProbe, 
				 float realWeight)
{
//   In a ROOT session, you can do:
//      Root > .L PUCorrectedFitterTree.C
//      Root > PUCorrectedFitterTree t
