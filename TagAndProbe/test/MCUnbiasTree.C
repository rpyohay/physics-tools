...
void MCUnbiasTree::Loop(TTree* tree, Float_t& totalWeight, Float_t& SCEta, 
			Int_t& probePassingRhoSigmaIetaIetaEB, 
			Int_t& probePassingNPVSigmaIetaIetaEB, float realWeight)
{
//   In a ROOT session, you can do:
//      Root > .L PhotonToECALIso_mcUnbias_tree.C
//      Root > PhotonToECALIso_mcUnbias_tree t
