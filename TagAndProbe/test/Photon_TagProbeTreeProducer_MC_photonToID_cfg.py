...
outputFile = "/data/yohay/tagProbeTree_MC_MCANCuts/tagProbeTree_MC_photonToID.root"
...
readFiles.extend([
    #FILES
    'file:/data2/yohay/Summer10_Zee/job102.root',
    'file:/data2/yohay/Summer10_Zee/slim_1.root',
    'file:/data2/yohay/Summer10_Zee/slim_2.root',
    'file:/data2/yohay/Summer10_Zee/slim_3.root',
    'file:/data2/yohay/Summer10_Zee/slim_4.root',
    'file:/data2/yohay/Summer10_Zee/slim_5.root',
    'file:/data2/yohay/Summer10_Zee/slim_6.root',
    'file:/data2/yohay/Summer10_Zee/slim_7.root',
    'file:/data2/yohay/Summer10_Zee/slim_8.root'
    ])
...
#photons to clean from jet collection
process.realPhotons = cms.EDFilter(
    "PhotonSelector",
    src = cms.InputTag("probePhotonsEB"),
    cut = cms.string(process.probePhotonsPassingIsolationEB.cut.value() +
                     " && (hadronicOverEm < 0.05)"
...
process.IDedJetProducer03 = cms.EDProducer(
    ...
    jetIDSrc = cms.InputTag("ak5JetID", "", "RECO"),
    JPTJetSrc = cms.InputTag("JetPlusTrackZSPCorJetAntiKt5", "", "RECO"),
    photonSrc = cms.InputTag("realPhotons"),
...
#produce dR(photon, 2nd nearest IDed uncorrected jet passing cuts on corrected eta and pT)
#use jets cleaned with dR = 0.0 algorithm
...
#produce dR(photon, 3rd nearest IDed uncorrected jet passing cuts on corrected eta and pT)
#use jets cleaned with dR = 0.0 algorithm
...
process.ext_ToNearestJet_sequence = cms.Sequence(
    process.IDedJetProducer00 + process.ak5JPTJetsL2L300 +
    ...
    process.realPhotons *
    (process.IDedJetProducer03 + process.IDedJetProducer05 + process.IDedJetProducer07 +
     process.IDedJetProducer09 + process.ak5JPTJetsL2L303 + process.ak5JPTJetsL2L305 +
