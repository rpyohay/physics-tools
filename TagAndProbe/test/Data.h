...
// Wed Jan 11 20:32:57 2012 by ROOT version 5.27/06b
// from TTree fitter_tree/fitter_tree
// found on file: /data2/yohay/RA3/data_tagProbeTrees/Aug05ReReco_17-8/tagProbeTree.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
     TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/data2/yohay/RA3/data_tagProbeTrees/Aug05ReReco_17-8/tagProbeTree.root");
      if (!f) {
	f = new TFile("/data2/yohay/RA3/data_tagProbeTrees/Aug05ReReco_17-8/tagProbeTree.root");
      }
