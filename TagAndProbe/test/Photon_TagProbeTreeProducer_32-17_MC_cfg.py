...
process.IsoVLR9IdTo32CaloIdL26CaloIdLLeading.eventWeight = cms.double(EVENT_WEIGHT)
process.IsoVLTo32CaloIdL26CaloIdLLeading.eventWeight = cms.double(EVENT_WEIGHT)
process.R9IdTo32CaloIdL26CaloIdLLeading.eventWeight = cms.double(EVENT_WEIGHT)
process.IsoVLR9IdTo32CaloIdL26CaloIdLTrailing.eventWeight = cms.double(EVENT_WEIGHT)
process.IsoVLTo32CaloIdL26CaloIdLTrailing.eventWeight = cms.double(EVENT_WEIGHT)
process.R9IdTo32CaloIdL26CaloIdLTrailing.eventWeight = cms.double(EVENT_WEIGHT)
...
process.IsoVLR9IdTo32CaloIdL26CaloIdLLeading.xSec = cms.double(XSEC)
process.IsoVLTo32CaloIdL26CaloIdLLeading.xSec = cms.double(XSEC)
process.R9IdTo32CaloIdL26CaloIdLLeading.xSec = cms.double(XSEC)
process.IsoVLR9IdTo32CaloIdL26CaloIdLTrailing.xSec = cms.double(XSEC)
process.IsoVLTo32CaloIdL26CaloIdLTrailing.xSec = cms.double(XSEC)
process.R9IdTo32CaloIdL26CaloIdLTrailing.xSec = cms.double(XSEC)
...
process.IsoVLR9IdTo32CaloIdL26CaloIdLLeading.nEvts = cms.double(NEVTS)
process.IsoVLTo32CaloIdL26CaloIdLLeading.nEvts = cms.double(NEVTS)
process.R9IdTo32CaloIdL26CaloIdLLeading.nEvts = cms.double(NEVTS)
process.IsoVLR9IdTo32CaloIdL26CaloIdLTrailing.nEvts = cms.double(NEVTS)
process.IsoVLTo32CaloIdL26CaloIdLTrailing.nEvts = cms.double(NEVTS)
process.R9IdTo32CaloIdL26CaloIdLTrailing.nEvts = cms.double(NEVTS)
