...
process.TagProbeFitTreeAnalyzer = cms.EDAnalyzer(
    ...
    "/data2/yohay/DIR_NAME/tagProbeTree_data_photonToID_finalv2.root"
    ),
    ...
    "/data2/yohay/DIR_NAME/shape_model_systematic/efficiency_INPUT_DIRECTORY_NAME_alphaPassALPHAPASSINFILENAME_nPassNPASSINFILENAME_alphaFailALPHAFAILINFILENAME_nFailNFAILINFILENAME_bkgBKG_SHAPE_LABEL.root"
    ),
    ...
    "RooCBShape::signalResPass(mass, meanPass[0.0, -1.0, 1.0], widthPass[1.8, 1.0, 3.0], alphaPass[ALPHAPASS], nPass[NPASS])",
    "RooCBShape::signalResFail(mass, meanFail[0.0, -1.0, 1.0], widthFail[1.8, 1.0, 3.0], alphaFail[ALPHAPASS], nFail[NPASS])",
