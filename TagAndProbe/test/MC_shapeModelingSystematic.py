...
process.TagProbeFitTreeAnalyzer = cms.EDAnalyzer(
    ...
    "/data2/yohay/eff_MC/shape_model_systematic/efficiency_INPUT_DIRECTORY_NAME_alphaPassALPHAPASSINFILENAME_nPassNPASSINFILENAME_alphaFailALPHAFAILINFILENAME_nFailNFAILINFILENAME_bkgBKG_SHAPE_LABEL.root"
    ),
    ...
    "RooCBShape::signalResFail(mass, meanFail[0.0, -1.0, 1.0], widthFail[1.8, 1.0, 3.0], alphaFail[ALPHAFAIL], nFail[NFAIL])",
