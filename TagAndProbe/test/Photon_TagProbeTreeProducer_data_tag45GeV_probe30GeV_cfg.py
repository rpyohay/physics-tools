...
HLTSUBFILTER2 = "hltEG36CaloIdLClusterShapeLastFilter"
HLTSUBFILTER3 = "hltEG40CaloIdLHEFilter"
InputTagProcess = "HLT"
RECOProcess = "RECO"
...
process.probePhotons.cut = cms.string("(hadronicOverEm < 0.1) && (et > 30.0) && ((abs(superCluster.eta) < 1.4442) || ((abs(superCluster.eta) > 1.566) && (abs(superCluster.eta) < 2.5)))")
...
process.trackMatchedPhotons.srcObjectsToMatch = cms.VInputTag(cms.InputTag("generalTracks", "",
                                                                           RECOProcess))
process.goodPhotons.cut = cms.string("(sigmaIetaIeta < 0.009) && (hasPixelSeed = 1.0) && (hadronicOverEm < 0.05) && (pt > 45.0) && (abs(superCluster.eta) < 1.4442) && (ecalRecHitSumEtConeDR04 < (0.006*pt + 4.2)) && (hcalTowerSumEtConeDR04 < (0.0025*pt + 2.2)) && (trkSumPtHollowConeDR04 < (0.001*pt + 2.0))")
